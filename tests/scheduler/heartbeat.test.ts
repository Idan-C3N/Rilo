...
const job = () => ({ id: 1, user_id: uid, type: 'heartbeat' as const, fire_at: 0, payload: {}, status: 'pending' as const, recurrence: null, recurrence_until: null, recurrence_count: null, attempts: 0 });
